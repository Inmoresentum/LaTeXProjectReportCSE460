...
\begin{document}
    ...
    \begin{abstract}
        ...
        as well as logical operations such as \textbf{\textif{ADD}}, \textbf{\textit{NAND}}, and \textbf{\textit{XNOR}}
    ...
    \section{Finite State Machine Design and Implementation}\label{sec:ease-of-use}
...
%    Todo: Will be adding a figure here.
